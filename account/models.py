...
class Account(SkeletonU):
    ...
    btc = models.DecimalField('BTC', max_digits=16, decimal_places=8, null=False, blank=False, default=0)
    ltc = models.DecimalField('LTC', max_digits=16, decimal_places=8, null=False, blank=False, default=0)
